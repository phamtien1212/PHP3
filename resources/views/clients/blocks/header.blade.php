            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{ asset('assets/client/img/logo/logo1.png')}}" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                    <!-- start logo area -->
                            ...
                            <div class="main-menu">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        ...
                                        <li class="position-static"><a href="#">Danh mục </a>
                                        
                                        </li>
                                        <li><a href="{{ route('list.product')}}">Sản phẩm </a>
                                ...
                                <ul class="nav justify-content-end">
                                    <li class="user-hover">
                                        ...
                                        <ul class="dropdown-list">
                                            ...
                                            <li><a href="{{ route('cart.list')}}">my account</a></li>
