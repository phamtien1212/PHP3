                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>Tổng tiền hàng: <b>{{ number_format($donHang->tien_hang, 0, '', '.') }} đ</b></li>
                                            <li>Tổng tiền ship: <b>{{number_format($donHang->tien_ship, 0, '', '.') }} đ</b></li>
                                            <li>Tổng tiền đơn hàng: <b class="text-danger">{{ number_format($donHang->tong_tien, 0, '', '.') }} đ</b></li>
                                          </ul>
                                    </td>  
                                </tr>
                            </tbody>       
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ Storage::url($sanPham->hinh_anh)}}" alt="" style="width:100px ;">
                                    </td>
