                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ten_san_pham" name="ten_san_pham"
                                            ...
                                            value="{{ old('ten_san_pham') }}" placeholder="Tên danh mục">
                                        @error('ten_san_pham')
                                            <p class="text-danger"> {{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="gia_san_pham" name="gia_san_pham"
                                            ...
                                            value="{{ old('gia_san_pham') }}" placeholder="Tên danh mục">
                                        @error('gia_san_pham')
                                            <p class="text-danger"> {{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai"
                                            ...
                                            value="{{ old('gia_khuyen_mai') }}" placeholder="Tên danh mục">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="" id="img_danh_muc" alt="hình ảnh danh mục"
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="https://cdn-icons-png.flaticon.com/512/1160/1160358.png"
                                                            id="preview_0" alt="" style="width: 40px;"
                                                            class="me-3">
                                                        <input type="file" id="hinh_anh" name="list_hinh_anh[id_0]"
                                                            class="form-control mf-3 " onchange="previewImage(this, 0)">
                                                    </td>
                                                    <td>
